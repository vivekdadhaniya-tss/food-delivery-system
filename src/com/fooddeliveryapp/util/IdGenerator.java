...
public final class IdGenerator {
    ...
    private IdGenerator() {} // prevent object creation
    ...
    public static int nextRestaurantId() {
        return RESTAURANT_ID.getAndIncrement();
    }

    public static int nextAgentId() {
        return AGENT_ID.getAndIncrement();
    }

    public static String nextOrderNumber() {
        return "ORD-" + ORDER_ID.getAndIncrement();
    }

    public static String nextPaymentId() {
        return "PAY-" + PAYMENT_ID.getAndIncrement();
    }
}